    ...
    ueditorConfig: {
      ...
      default() {
        return {
          ...
          toolbars: [
            [
              'undo', 'indent', 'forecolor', 'backcolor', 'redo', 'bold',
              'Italic', 'Underline', '|', 'StrikeThrough', 'Horizontal', 'Date',
              'FontFamily', 'FontSize', 'LineHeight', 'CustomStyle', 'JustifyLeft',
              'JustifyRight', 'JustifyCenter', 'link', 'RemoveFormat',
            ],
          ],
  ...
  methods: {
    insertScriptTag() {
      ...
      if (configScriptTag.loaded) {
        this.scriptTagStatus = this.scriptTagStatus + 1;
      } else {
